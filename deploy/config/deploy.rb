...
server '51.15.39.10', roles: [:web, :app, :db], port: fetch(:port), user: fetch(:user), primary: true
set :application_name, "hours"
set :repo_url, 'git@github.com:Lyubomyr/Hours.git'
set :nginx_server_name, "hours.sangatek.com"
...
set :linked_files, %w{config/database.yml config/unicorn.rb .ruby-version} + [fetch(:env_file)]
